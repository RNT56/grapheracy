...
from graphview_api.schemas import AgentToolCallCreate, AgentToolCallOut, GraphQueryCreate, ProposalCreate


def create_agent_tools_router(repo_provider: Callable[[], GraphRepository]) -> APIRouter:
    router = APIRouter()
