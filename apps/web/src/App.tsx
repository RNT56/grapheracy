...
interface ApiSourceReviewCoverage {
  source_count: number;
  proposal_count: number;
  pending_count: number;
...
interface ApiConnectorDescriptor {
...
interface ApiAgentActionProposal {
  id: string;
  agent_run_id: string;
  action_type: string;
...
interface ApiGeneratedArtifact {
  id: string;
...
interface ApiGraphResearchResult {
  research_task: {
    id: string;
    status: string;
    query: string;
...
interface ApiGraphActivityEvent {
  id: string;
  project_id: string;
...
interface ApiGraphActivityResponse {
  generated_at?: string;
  returned_count?: number;
...
interface ApiOperationalAttentionItem {
  id: string;
  kind: string;
  status: string;
  severity: string;
...
interface ApiOperationalAttentionResponse {
  generated_at: string;
  returned_count: number;
...
interface ApiOperationalActionProposal {
  id: string;
  decision_record_id?: string | null;
  alert_id?: string | null;
  attention_item_id?: string | null;
...
interface ApiOperationalActionRun {
  id: string;
...
interface ApiOperationalOutcome {
  id: string;
  action_run_id?: string | null;
  attention_item_id?: string | null;
  status: string;
...
type ContentExpansionRole = "source" | "chunk" | "proposal" | "decision" | "task";
