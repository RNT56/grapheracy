...
const boundedLegacyFiles = {
  ...
  "services/api/src/graphview_api/repository.py": 1200
};
...
const requiredBoundaries = [
  ...
  "apps/web/src/workspaceTypes.ts",
  "apps/web/src/workspaceModel.ts",
  "apps/web/src/sourceContentModel.ts",
  ...
  "apps/web/src/useWorkspaceQueries.ts",
  "apps/web/src/useGraphQueries.ts",
  "apps/web/src/useAttentionQueries.ts",
  "apps/web/src/useConnectorQueries.ts",
  "apps/web/src/usePlanningQueries.ts",
  "apps/web/src/useAgentContextQueries.ts",
  ...
  "services/api/src/graphview_api/repository_ai.py",
  "services/api/src/graphview_api/repository_ingestion.py",
  "services/api/src/graphview_api/repository_nervous_system.py",
  "services/api/src/graphview_api/repository_agent_context.py",
  "services/api/src/graphview_api/repository_review.py",
  "services/api/src/graphview_api/repository_operations.py",
